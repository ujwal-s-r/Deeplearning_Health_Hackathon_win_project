...
class GazeEstimator5:
    ...
    def __init__(self, pupil_threshold=50):
        """
        Initializes the GazeEstimator5.
        ...
        if results.multi_face_landmarks:
            ...
            try:
                ...
                right_pupil_abs = (int(right_pupil_lm.x * frame_width), int(right_pupil_lm.y * frame_height))
                 ...
                 print("Pupil landmarks not found, refine_landmarks might be needed.")
                 pass
    ...
    def _process_eye(self, roi_gray, eye_region):
        ...
        try:
            eye_roi_equalized = cv2.equalizeHist(eye_roi)
             ...
             print(f"cv2.equalizeHist error: {e}. Eye ROI shape: {eye_roi.shape}")
    ...
    def _determine_gaze_direction(self, left_eye_percentages, right_eye_percentages):
        ...
        # If more pupil is on the left side of the eyes, user is looking RIGHT
        if avg_left_percentage > avg_right_percentage + threshold:
            direction = "Looking Right" 
        # If more pupil is on the right side of the eyes, user is looking LEFT
    ...
    def analyze_frame(self, frame):
        ...
        metrics = {
            ...
            "avg_left_perc": 0.0,
            "avg_right_perc": 0.0,
            "left_pupil_coords": left_pupil_abs, # Store absolute pupil coords if found
        ...
        if self.face_detected and face_coords and face_roi_gray is not None:
            ...
            if self.eyes_detected and eye_regions_relative and len(eye_regions_relative) == 2:
                ...
                # Optionally, draw MediaPipe pupil landmarks if available and different
                #if left_pupil_abs:
                #    cv2.circle(annotated_frame, left_pupil_abs, 3, (255, 0, 255), -1) # Magenta
                #if right_pupil_abs:
                #    cv2.circle(annotated_frame, right_pupil_abs, 3, (255, 0, 255), -1) # Magenta
    ...
    def get_last_metrics(self):
        ...
        return {
            ...
            "left_pupil_coords": self.last_left_pupil_coords, # Absolute coords from MediaPipe
            "right_pupil_coords": self.last_right_pupil_coords, # Absolute coords from MediaPipe
        }
